        ...
        while not self.stop_event.is_set():
            ...
            if minuto_atual % 5 == 0:
                ...
                for ativo in ativos:
                    ...
                    self.log(f"Análise {ativo}: {directions_atuais} -> SINAL para MINORIA: {direcao_entrada_real.upper()}", "#00FFFF")
    ...
    def verificar_condicoes_parada(self):
        if self.config['stop_lucro']:
            ...
            if alvo_perda > 0 and self.lucro_acumulado <= -alvo_perda:
                ...
                return True
        else: # Stop por número de entradas
...
class BotFullApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Nova opção para Entradas Simultâneas
        row += 1
